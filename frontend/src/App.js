...
//return
  ...
  <div className="popup-overlay">
    <div className="popup-box">
      <h2>🌿 Crop Disease Detection System</h2>
     
      <p>This appliaction detects crop leaf diseases using Deep Learning and provides treatment recomendations.</p>

      <p><b>Supported Crops:</b></p>
    ...
    <span>✅Crop Question Answering</span>
</div>

<div className="feature-row">
    <span>✅English & Tamil Responses</span>
    <span>✅Voice Reading (Eng/Tam)</span>
</div>
      
      <p style={{fontWeight:'400'}}>
        ⚠️ Please upload a clear leaf image of one of the supported crops.
        Other images or unsupported crops may produce inaccurate results.
      </p>
